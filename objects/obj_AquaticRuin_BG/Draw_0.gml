...
// Draw the Treetops
	...
	scr_draw_background_tiled_area(bg_aquaticruin_depths, 0,  0, __view_get( e__VW.XView, view_current ) * 0.7, __view_get( e__VW.YView, view_current ) * globalYScroll + 448 , __view_get( e__VW.XView, view_current ) * 0.3 + __view_get( e__VW.WView, 0 ), 128);
 // Draw the Clouds
