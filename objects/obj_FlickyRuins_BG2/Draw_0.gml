/// @description  Draw the Flicky Ruins Background.
 ...
 // Draw the Mountains (This is the most basic one; this outlines what you're basically supposed to do.)
	...
	//scr_draw_background_tiled_area(bg_flicky_ruins_parallax_cave01, 0,  0, __view_get( e__VW.XView, view_current ) * 0.875, __view_get( e__VW.YView, view_current ) * 0.900 , __view_get( e__VW.XView, view_current ) * 0.125 + __view_get( e__VW.WView, 0 ), 128);
	//scr_draw_background_tiled_area(bg_flicky_ruins_parallax_cave01, 0,  0, __view_get( e__VW.XView, view_current ) * 0.875, __view_get( e__VW.YView, view_current ) * 0.900 + 200, __view_get( e__VW.XView, view_current ) * 0.125 + __view_get( e__VW.WView, 0 ), 128);