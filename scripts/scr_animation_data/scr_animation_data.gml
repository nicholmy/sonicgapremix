/// @description scr_animation_data();
// Set and read the data for each animation.
  ...
  /*** Mighty Animation: ***/      
  if(CharacterID = CharacterMighty && CharacterState = CharacterNormal){
  ...
  /*** Ray Animation: ***/      
  if(CharacterID = CharacterRay && CharacterState = CharacterNormal){
 
     scr_animation_data_ray();
