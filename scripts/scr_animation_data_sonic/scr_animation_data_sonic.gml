/// @description  scr_animation_data_sonic()
//  All of Sonics Animations are stored here:
  ...
  // Lookup Animation   
     if(Animation = "LOOK_UP"){
        AnimationSprite      = spr_sonic_lookup;     
        AnimationStart       = 0;
        AnimationEnd         = 1;
        AnimationLoop        = 1;
        AnimationSpeed       = 0.15;
  ...
  // Crouch Animation   
     if(Animation = "CROUCH"){
        AnimationSprite      = spr_sonic_crouch;     
        AnimationStart       = 0;
        AnimationEnd         = 1;
        AnimationLoop        = 1;
        AnimationSpeed       = 0.15;
  ...
  // Walk Animation            
     if(Animation = "WALK"){
        AnimationSprite      = spr_sonic_walk;
        AnimationStart       = 0;
        AnimationEnd         = 7;
        AnimationLoop        = 0;
  ...
  // Push Animation            
     if(Animation = "PUSH"){
        AnimationSprite      = spr_sonic_push;         
        AnimationStart       = 0;
        AnimationEnd         = 4;
        AnimationLoop        = 1;
  ...
  // Jump/Roll Animation            
     if(Animation = "ROLL"){
        AnimationSprite      = spr_sonic_roll;         
        AnimationStart       = 0;
        AnimationEnd         = 7;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.2;
  ...
  // Peelout Animation:
     if(Animation = "PEELOUT"){
        AnimationSprite      = spr_sonic_peelout;         
        AnimationStart       = 0;
        AnimationEnd         = 4;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.8;
  ...
  // Skidding Animation            
     if(Animation = "SKID"){
        AnimationSprite      = spr_sonic_skid;         
        AnimationStart       = 0;
        AnimationEnd         = 2;
        AnimationLoop        = 2;
        AnimationSpeed       = 0.50;
  ...
  // Spring Animation            
     if(Animation = "SPRING"){
        AnimationSprite      = spr_sonic_spring;         
        AnimationStart       = 0;
        AnimationEnd         = 0;
        AnimationLoop        = 0;
        AnimationSpeed       = 0;
  ...
  // Edge wobble 1 Animation            
     if(Animation = "EDGEWOBBLE_1"){
        AnimationSprite      = spr_sonic_edge_balance;         
        AnimationStart       = 0;
        AnimationEnd         = 2;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.15;
  ...
  // Hurt Animation            
     if(Animation = "HURT"){
        AnimationSprite      = spr_sonic_hurt;         
        AnimationStart       = 0;
        AnimationEnd         = 1;
        AnimationLoop        = 0;
        AnimationSpeed       = 0.10;
  ...
  // Goal Animation            
     if(Animation = "GOAL"){
        AnimationSprite      = spr_sonic_goal;         
        AnimationStart       = 0;
        AnimationEnd         = 4;
        AnimationLoop        = 1;
        AnimationSpeed       = 0.10;
  ...
  // Standing Spin:
     if(Animation = "SPIN"){
        AnimationSprite      = spr_sonic_spin;         
        AnimationStart       = 0;
        AnimationEnd         = 11;
        AnimationLoop        = 0;
        AnimationSpeed       = 0;
