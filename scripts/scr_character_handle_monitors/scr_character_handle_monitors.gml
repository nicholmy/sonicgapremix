/// @description  scr_character_handle_monitors(Collision Type);
...
//  Script to handle one of the main features in Sonic games. Monitors!
    ...
    // Check if we collide with it after jumping:
       if(argument0 == "Top"){
          ...
          if((Monitor && YSpeed >= 0 && ((Action = ActionJump && CharacterID != CharacterAmy || CharacterID == CharacterAmy && AmyHammerAttack = 3) || Action = ActionRolling || Action = ActionNormal && Animation == "ROLL" || Action = ActionHammerDrop))){
